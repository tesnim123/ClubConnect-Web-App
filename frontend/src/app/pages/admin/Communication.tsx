      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-[#F7F8FC] p-6 flex items-center justify-center">
          <Card className="p-12 text-center max-w-md">
            ...
            <h1 className="text-2xl font-bold text-[#1B2A4A] mb-2">Communication</h1>
            <p className="text-gray-600">Accès à tous les canaux et messages directs avec les présidents</p>
          </Card>
        </main>
      </div>
    </div>
